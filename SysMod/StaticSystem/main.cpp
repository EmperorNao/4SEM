...
int main () {
	...
	if (solution.size() != 0) {
		...
		for (int i = 0; i < solution.size(); ++i) {
			...
			double t = (solution[i].value * 180 / 3.14159562) - int(solution[i].value * 180 / 3.14159562);
			std::cout << "фи_" << i + 1 << " = " << (int(solution[i].value * 180 / 3.14159562) % 90 + 360) % 360 + t << " градусов" << std::endl;
